...
- materiais de apoio;
- trechos ilustrativos das entrevistas;
- um checklist e o critério de passagem para a etapa seguinte.

A tela inicial traz a definição de collab adotada no trabalho, as duas lentes teóricas (Market Orientation e Dynamic Capabilities), os fatores críticos identificados e a matriz que cruza capacidades e etapas.

## Procedência do conteúdo

O conteúdo das cinco etapas vem do Quadro 5 da dissertação, item 4.8. As citações vêm do capítulo 4.
...
- Navegação por teclado: `1` a `5` para as etapas, `0` ou `h` para o início, setas para avançar e voltar.
...
> BOCALÃO, Douglas R. **Toolkit de collabs: framework de aplicação**. Versão 1.0. São Paulo, 2026. Disponível em: https://USUARIO.github.io/REPO/. Acesso em: DATA.
